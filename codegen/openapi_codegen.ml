...
let header manifest definition_count =
  Printf.sprintf
    "(** Generated by ocaml-kube from Kubernetes %s OpenAPI v2.\n\
    \    Source: %s\n\
    \    Upstream SHA-256: %s\n\
  ...
  `Assoc
    [
      ...
      ( "info",
        `Assoc
          [
            ("title", `String "ocaml-kube generated API dependency closure");
            ("version", `String manifest.kubernetes_version);
          ] );
      ("x-ocaml-kube-upstream-source", `String manifest.source);
      ("x-ocaml-kube-upstream-sha256", `String manifest.sha256);
